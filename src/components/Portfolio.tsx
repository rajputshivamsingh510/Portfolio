...
const Portfolio = () => {
  ...
  const handleProjectZipDownload = () => {
    const link = document.createElement('a');
    link.href = '/ai-ml-portfolio-super.zip';
    link.download = 'ai-ml-portfolio-super.zip';
    link.click();
  };
  ...
  const HeroSection = () => (
    <section
      ...
      className={`min-h-screen flex items-center justify-center relative overflow-hidden ${
        darkMode ? 'bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900' : 'bg-gradient-to-br from-blue-50 via-white to-purple-50'
      }`}
    >
      <ParticleBackground />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <motion.button
              onClick={handleResumeDownload} className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold flex items-center justify-center space-x-2"
            ...
            <motion.button
              className={`border-2 ${
                darkMode ? 'border-blue-400 text-blue-400 hover:bg-blue-400' : 'border-blue-600 text-blue-600 hover:bg-blue-600'
          ...
          <motion.button
              ...
              className="mt-4 bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-lg font-semibold flex items-center justify-center space-x-2"
        ...
        <motion.div
          ...
          transition={{ duration: 2, repeat: Infinity }}
        >
          <ChevronDown size={32} className={darkMode ? 'text-white' : 'text-gray-900'} />
        </motion.div>
      </div>
    </section>
  );
